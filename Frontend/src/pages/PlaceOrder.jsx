    ...
    <div className="min-h-screen bg-[color:var(--background)] pt-16 pb-16">
      {toast.show && (
        <div className="fixed top-20 right-4 z-[9999] animate-[slideIn_.35s_ease-out]">
          <div
            className={`rounded-2xl px-4 py-3 shadow-2xl border text-sm font-semibold flex items-center gap-3 ${
              toast.type === "success"
...
const PaymentCard = ({ active, onClick, icon, title, desc }) => {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`smooth-enter w-full p-4 rounded-2xl border text-left transition-all ${
        active
